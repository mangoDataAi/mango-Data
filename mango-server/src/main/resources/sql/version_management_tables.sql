...
CREATE INDEX idx_mvr_version_number ON metadata_version_record (version_number);
...
COMMENT ON COLUMN metadata_version_change_log.changer_id IS '变更人ID';
COMMENT ON COLUMN metadata_version_change_log.changer_name IS '变更人名称';
